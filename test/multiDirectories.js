    ...
    describe('Global Scope', function() {
        ...
        describe('i18nTranslate', function() {
            ...
            it('should return fr translations as expected', function() {
                ...
                should.equal(__('Hello %s, how are you today?', 'Marcus', 'secondLocales'), 'Bonjour Marcus, comment allez-vous aujourd\'hui?');
                should.equal(__('Hello %s, how are you today? How was your %s.', 'Marcus', __('weekend'), 'secondLocales'), 'Bonjour Marcus, comment allez-vous aujourd\'hui ? Comment était votre week-end.');
            });
            ...
            it('should return en translations as expected, using mustached messages', function() {
                ...
                should.equal(__('Hello {{name}}, how was your %s?', __('weekend'), { name: 'Marcus' }, 'secondLocales'), 'Bonjour Marcus, comment était votre week-end?');
            });
            it('should return fr translations as expected, using mustached messages', function() {
                ...
                // nested
                should.equal(__(__('Hello {{name}}, how was your %s?', { name: 'Marcus' }, 'secondLocales'), __('weekend'), 'secondLocales'), 'Bonjour Marcus, comment était votre week-end?');
            });
            ...
            it('should be possible to use an json object as 1st parameter to specifiy a certain locale for that lookup', function() {
                ...
                //should.equal(__({ phrase: 'Hello {{name}}', locale: 'fr' }, { name: 'Marcus' }, 'secondLocales'), 'Bonjour Marcus');
            });
