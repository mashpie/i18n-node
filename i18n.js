...
module.exports = (function () {
    ...
    i18n.configure = function i18nConfigure(opt) {
        ...
        // sets a custom header name to parse locale settings from
        customHeader = (typeof opt.header === 'string') ? opt.header : null;
    ...
    var guessLanguage = function (request) {
        if (typeof request === 'object') {
            ...
            // a custom header overwrites 'accept-language' headers
            if (customHeader && request.headers && request.headers[customHeader]) {
                request.language = request.headers[customHeader];
                return i18n.setLocale(request, request.language);
            }
